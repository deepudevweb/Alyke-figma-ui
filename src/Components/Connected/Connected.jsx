        ...
        <div className={`connected ${animate ? 'animate' : ''}`}>
            <div className="left-side">
                ...
                <div className="left-inner">
                    <h3 className='business-top'><span className='business'><GrBusinessService size={32} className='business-icon' /></span>Quarterly Business Updates</h3>
                    ...
                    <h3 className='business-heading'><span className='business'><HiOutlineChatBubbleLeftRight size={32} className='business-icon' /></span>Industery Events & Networking</h3>
                    <h3 className='business-heading'><span className='business'><RiContactsBook2Line size={32} className='business-icon' /></span>Associations Memberships</h3>
                </div>
            </div>
